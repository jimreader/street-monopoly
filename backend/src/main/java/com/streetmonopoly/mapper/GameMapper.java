...
public interface GameMapper {
    ...
    List<Game> findActiveReadyToEnd();
        ...
        @Insert("INSERT INTO game (id, event_id, name, game_map_id, start_time, end_time, starting_balance, proximity_metres, status) " +
            "VALUES (#{id}, #{eventId}, #{name}, #{gameMapId}, #{startTime}, #{endTime}, #{startingBalance}, #{proximityMetres}, #{status})")
